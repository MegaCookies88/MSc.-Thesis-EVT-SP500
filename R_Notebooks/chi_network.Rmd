...
c = chi(ll$S.P.Health.Care,ll$S.P.Real.Estate)
```
...
plot(nx, vertex.cex=1, label.cex=0.8, displaylabels=TRUE, boxed.labels=FALSE, mode="circle", main="Chi Threshold = 0.5")
```
...
nx = network(nx_adj, directed=FALSE)
plot(nx, vertex.cex=1, label.cex=0.8, displaylabels=TRUE, boxed.labels=FALSE, main="Chi Threshold = 0.6")
```
...
plot(nx, vertex.cex=1, label.cex=0.8, displaylabels=TRUE, boxed.labels=FALSE, main="Chi Threshold = 0.7")
```
