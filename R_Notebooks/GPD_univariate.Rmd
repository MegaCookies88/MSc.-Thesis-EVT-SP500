...
abline(v=quantile(x1, 0.80, na.rm=TRUE), col=c2, untf=TRUE)
abline(h=quantile(x2, 0.80, na.rm=TRUE), col=c2, untf=TRUE)
...
title(main="MLE Logistic BEVD - Threshold = 2", outer=TRUE, line=-2)
```
